...
import { Indicacao, ReferralStatus, Usuario, Candidato, getStatusColor } from './types';
    ...
    return (
      <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="space-y-4">
          ...
          <ReferralTable referrals={referrals.slice(0, 5)} onViewDetails={(ref) => { setSelectedReferral(ref); setActiveTab('details'); }} />
        </div>
      </div>
    );
  };
          ...
          <form onSubmit={handleCreateReferral} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input required value={formPhone} onChange={e => setFormPhone(e.target.value)} type="tel" className="w-full rounded-xl border-slate-200 dark:bg-slate-800 dark:border-slate-700 focus:ring-primary focus:border-primary px-4 py-3" placeholder="(00) 00000-0000" />
              </div>
